...
public class ProfilingAdvice {
	/*
	 * public void afterThrowing(JoinPoint joinPoint) { String methodName =
	 * joinPoint.getSignature().toShortString(); System.out.println(methodName +
	 * "가 비정상적으로 종료하였습니다."); }
	 */
	...
	/*
	 * public void afterReturning(JoinPoint joinPoint) { String methodName =
	 * joinPoint.getSignature().toShortString(); System.out.println(methodName +
	 * "가 정상완료 후 입니다."); }
	 */
	...
	/*
	 * public void before() { System.out.println("타깃이 되는 메소드 실행하기 전입니다."); }
	 */
